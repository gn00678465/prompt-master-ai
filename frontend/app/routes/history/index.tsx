...
import { Search, Calendar, Copy, RotateCcw, Trash2, ArrowLeft, Clock, Lightbulb } from "lucide-react"
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-muted-foreground">溫度: {item.temperature}</span>
                      </div>
