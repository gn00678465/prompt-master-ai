...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('template_id', sa.Integer, sa.ForeignKey('templates.template_id'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('default_model', sa.String(length=100), nullable=False, server_default=sa.text("'gemini-pro'")),
        sa.Column('default_temperature', sa.Float, nullable=False, server_default=sa.text("0.7")),
        sa.Column('default_template_id', sa.Integer, sa.ForeignKey('templates.template_id'), nullable=True),
